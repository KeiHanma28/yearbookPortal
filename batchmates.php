                        ...
                        <div class="inner bg-light lter">
                           ...
                           <div class="box">
                             <ul class="nav nav-tabs">
                              ...
                              INNER JOIN psu_department cd ON usd.student_department = cd.department_ID WHERE usd.student_ID = $login_id");
                              ...
                              $dep =mysqli_query($con,"SELECT * FROM `psu_department`"); 
                              ...
                              while ($data = mysqli_fetch_array($dep)) {
                                ...
                                <div id="<?php echo $data['department_ID']; ?>" class="tab-pane fade in active">
                                  ...
                                  <p>
                                    ...
                                    <tbody>
                                    <?php 
                                    $s = mysqli_query($con,"SELECT student_fName,student_mName,student_lName,student_IDNumber FROM `user_student_detail` usd INNER JOIN psu_department cd ON usd.student_department = cd.department_ID WHERE department_ID = ".$data['department_ID']." AND student_year_grad LIKE '%$s_student_year_grad%'");
                                    $no = 0;
                                  ...
                                  ?>  <div id="<?php echo $data['department_ID']; ?>" class="tab-pane fade">
                                    ...
                                    while ($f_all = mysqli_fetch_array($s)) {
                                     ...
                                     ?>
                                      <tr>
                                             <td><?php echo ' - ' ?> <?php echo   $f_all['student_fName']." ".$f_all['student_mName']." ".  $f_all['student_lName']?></td>
                                             <td><?php echo $f_all['student_IDNumber']?></td>
                                         </tr>
                                     <?php
                                    }
                              ...
                              INNER JOIN psu_department cd ON usd.student_department = cd.department_ID WHERE usd.student_ID = 1


                              SELECT YEAR(usd.student_year_grad),cd.department_ID ,cd.department_name FROM `user_student_detail` usd
                              INNER JOIN psu_department cd ON usd.student_department = cd.department_ID 

                              SELECT YEAR(usd.student_year_grad),cd.department_ID ,cd.department_name,usd.student_fName FROM `user_student_detail` usd INNER JOIN psu_department cd ON usd.student_department = cd.department_ID WHERE department_ID = 1,2,3 -->
