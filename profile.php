    ...
    border-left-color: #ccc!important;">
                              ...
                              <a href="" class="pull-right btn btn-primary" data-toggle="modal" data-target="#test-modal">EDIT</a></h1>
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="bio-row">
                                                  <p><span>Parents: </span>: <?php echo $res_sidebar[$userType.'_parents'];?></p>
                                              </div>
                                                  <?php
                                                ...
                                                if ($userType == "student") 
                                                {
                                                  ?>
                                                   <div class="bio-row">
                                                  <p><span>Semester Graduated</span>: <?php echo $res_sidebar[$userType.'_semester'];?></p>
                                              </div>
                                                  <?php
                                                }
                                                ?>
                                                ...
                                                if ($userType == "student") 
                                                {
                                                  ?>
                                                   <div class="bio-row">
                                                  <p><span>Personal Motto </span>: " <?php 
                                                 
                                                  echo $res_sidebar[$userType.'_motto'];
                                                  ?> "</p>
                                              </div>
                                              <div class="bio-row">
                                                  <p><span>Achievements </span>: <?php echo $res_sidebar[$userType.'_achievements'];?></p>
                                              </div>
                                                  <?php
                                                }
                                                ?>
...
INNER JOIN psu_course cc ON cc.course_ID = usd.student_department  WHERE student_userID = $login_id");
                                                 ...
                                                 if ($userType == "teacher")
                                                  ...
                                                  <p><span>Personal Motto </span>: <?php echo $res_sidebar[$userType.'_motto'];?></p>
                                              <?php
                                                  }
                                                  else{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form class="form-horizontal" id="editModal" action="action/updateprofile.php" name="editModal">
        ...
        <div class="form-group">
        <label class="control-label col-lg-4">Change Messenger Picture</label>
        <div class="col-lg-2">
                <a class="btn btn-default" data-toggle="modal" data-target="#modal-changepic1">Update Messenger Picture</a>
            </div>
            </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="control-label col-lg-4">Personal Motto</label>
            <div class="col-lg-4">
                <a class="btn btn-default" data-toggle="modal" data-target="#modal-motto">Update Personal Motto</a>
            </div>
...
{?>
  <div class="form-group">
            <label class="control-label col-lg-4">Parents</label>
            <div class="col-lg-4">
                <a class="btn btn-default" data-toggle="modal" data-target="#modal-parents">Update Parents Name</a>
            </div>
<?php
}
?>
    ...
    <div class="modal-content"  >
      ...
      <div class="modal-body center" style="height: 250px;">
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group">
                   <input type="file" name="fileToProfile" id="fileToProfile">
                </div>
...
<div class="modal fade" id="modal-changepic1" data-modal-index="2" >
  <div class="modal-dialog">
    <div class="modal-content"  >
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
      ...
      <div class="modal-body center" style="height: 250px;">
              ...
              <div class="col-sm-6">
                <form class="form" action="uploadm.php?login_id=<?php echo $login_id?>" method="POST" enctype="multipart/form-data">
                Select image to upload:
                <div class="form-group">
                   <input type="file" name="fileTomessenger" id="fileTomessenger">
                </div>
               <input type="submit" value="Upload Image" name="submit" class="btn btn-primary">
              </form>
              </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
              <form class="form-horizontal" id="update_password" method="POST" action="action/updateprofile.php">
              <div class="form-group">
                  <label class="control-label col-lg-4">Password</label>
                  <div class="col-lg-4">
                      <input type="password" class="validate[required] form-control" name="new_password" id="update_password" value="">
                  </div>
              </div>
               <div class="form-group">
                  <label class="control-label col-lg-4">Confirm Password</label>
                  <div class="col-lg-4">
                      <input type="password" class="validate[required] form-control" name="new_repassword" id="update_password" value="">
                  </div>
              </div>
              <div class="form-group">
              <label class="control-label col-lg-4"></label>
              <div class="col-lg-4">
                  <input type="Submit" class="btn btn-primary" name="update_password" value="Submit">
              </div>
              </div>
              </form>
      </div>
...
<div class="modal fade" id="modal-motto" data-modal-index="2">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title">Edit Personal Motto</h4>
      </div>
      <div class="modal-body">
              <form class="form-horizontal" id="update_motto" method="POST"  action="action/updateprofile.php">
              <div class="form-group">
                  <label class="control-label col-lg-4">Personal Motto</label>
                  <div class="col-lg-4">
                      <input type="text" class="validate[required] form-control" name="new_motto" id="req" value="<?php echo $res_sidebar[$userType.'_motto'];?>">
                  </div>
              </div>
              <div class="form-group">
              <label class="control-label col-lg-4"></label>
              <div class="col-lg-4">
                  <input type="Submit" class="btn btn-primary" name="update_motto" value="Submit">
              </div>
              </div>
              </form>
      </div>
...
<div class="modal fade" id="modal-parents" data-modal-index="2">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title">Edit Parents Name</h4>
      </div>
      <div class="modal-body">
              <form class="form-horizontal" id="update_parents" method="POST"  action="action/updateprofile.php">
              <div class="form-group">
                  <label class="control-label col-lg-4">Parents Name</label>
                  <div class="col-lg-4">
                      <input type="text" class="validate[required] form-control" name="new_parents" id="req" value="<?php echo $res_sidebar[$userType.'_parents'];?>">
                  </div>
              </div>
              <div class="form-group">
              <label class="control-label col-lg-4"></label>
              <div class="col-lg-4">
                  <input type="Submit" class="btn btn-primary" name="update_parents" value="Submit">
              </div>
              </div>
              </form>
      </div>
