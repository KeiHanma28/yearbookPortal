                    ...
                    <div class="outer">
                        <header class="head">
                            ...
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item"><a href="recordstudent.php">Record Graduate Detail</a></li>
                              <li class="breadcrumb-item active">Record Graduate Detail Edit</li>
                            </ol>
                            </div>
                            <!-- /.main-bar -->
                        </header>
                        <div class="inner bg-light lter">
                         <div class="body" style="margin-top: 10px; margin-left: -45px;">
                            ...
                            $student_motto = $edit_sql['student_motto'];
                            ...
                            $student_semester = $edit_sql['student_semester'];
                            $student_year_grad = $edit_sql['student_year_grad'];
                            $student_contact = $edit_sql['student_contact'];
                            $student_parents = $edit_sql['student_parents'];
                            $student_achievements = $edit_sql['student_achievements'];
                            ?>
                                ...
                                <div class="form-group">
                                    <label for="text1" class="control-label col-lg-4">Motto</label>

                                    <div class="col-lg-8">
                                        <input type="text" id="text1" placeholder="Motto" class="form-control" name="student_motto"  value="<?php echo $student_motto;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="text1" placeholder="Mr. and Mrs." class="form-control" name="student_parents" required="" value="<?php echo $student_parents;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="text1" placeholder="Cum Laude/ Suma/ Magna" class="form-control" name="student_achievements" required="" value="<?php echo $student_achievements;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="text1" placeholder="Address" class="form-control" name="student_address" required=""  value="<?php echo $student_address;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="">
                                        <input type="year" class="form-control" name="student_year_grad" required=""  value="<?php echo $student_year_grad;?>">
