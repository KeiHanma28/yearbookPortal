...
$target_file = $target_dir . basename($_FILES["fileToProfile"]["name"]);
...
if (isset($_POST['submit']))
{
        ...
        else 
        {
            ...
            if ($data_img == 'temp.gif') {
                if (move_uploaded_file($_FILES["fileToProfile"]["tmp_name"], $target_file)) {
                    $imgName = $_FILES["fileToProfile"]["name"];
