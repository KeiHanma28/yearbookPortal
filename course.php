...
$sql = mysqli_query($con,"SELECT cc.course_ID,cd.department_name ,cc.course_name FROM psu_course cc
INNER JOIN psu_department cd ON cd.department_ID = cc.course_departmentID ");
...
<div id="add" class="modal fade" role="dialog">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10"> 
      ...
      <?php 
 $sql = mysqli_query($con,"SELECT * FROM `psu_department`");
