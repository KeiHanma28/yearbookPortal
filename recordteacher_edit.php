                         ...
                         <div class="body" style="margin-top: 10px; margin-left: -45px;">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="text1" placeholder="Address" class="form-control" name="teacher_address" required=""  value="<?php echo $teacher_address;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="text1" placeholder="Personal Motto" class="form-control" name="teacher_motto" required=""  value="<?php echo $teacher_motto;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                    <?php 
                                    $query_position = mysqli_query($con,"SELECT * FROM `position`");
                                    ?>
                                        <select class="form-control" name="teacher_position">
                                        <?php
                                        while ($res_pos = mysqli_fetch_array($query_position)) {
                                        
                                        ?>
                                            <option value="<?php echo $res_pos['position_id'] ?>"><?php echo $res_pos['position_name'];?></option>
                                        <?php 
                                        }
                                        ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                    <?php 
                                    $query_dep = mysqli_query($con,"SELECT * FROM `psu_department`");
                                    ?>
