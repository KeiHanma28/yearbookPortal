                ...
                <div id="content">
                    ...
                    <div class="outer">
                        ...
                        <div class="inner bg-light lter">
                            <center><h1>SUGGESTED  JOB</h1></center>
                            <hr>
...
INNER JOIN  psu_course cc ON sj.job_Course = cc.course_ID ORDER BY `job_ID` ASC");
...
<div id="add" class="modal fade" role="dialog">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10"> 
      ...
      <?php 
 $sql = mysqli_query($con,"SELECT * FROM `psu_course`");
