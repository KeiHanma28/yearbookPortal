     ...
     $dID =  $data['department_ID']; 
      ...
      <table  id="c" class="table table-bordered table-advance table-hover  dataTable">
                    ...
                    <br>
                      ...
                      <a href='yearbook_view.php?course=<?php echo $dID;?>&year=<?php echo $year_list;?> ' ><?php echo $year_list;?></a>
                     ...
                     <br>
                      ...
                      <a href='yearbook_view.php?course=<?php echo $dID;?>&year=<?php echo $year_list;?> ' style='background-color: #444444;color: white;'> VIEW</a>
                      </div></td>
                      </tr>
                                          <?php
                                        }
 ...
 $(document).ready(function() {
                ...
                var dataTable = $('#forumData_Pin').DataTable( {
                    ...
                    "columnDefs": [ {
                        ...
                        //          window.location='yearbook_view.php?course=IT&year='+year_data;
