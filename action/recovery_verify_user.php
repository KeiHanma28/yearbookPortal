...
else
{
    ...
    echo "<script>alert('Empty Recovery Detail');
      window.location='../index.php';
    </script>";
  }
  ...
  else
  {
    ...
    $result[$user_type.'_secretanswer'];
  }
  ...
  <div>
    ...
    <div class="text-center">
        <ul class="list-inline">
            <li><a class="text-muted " href="#Recovery" data-toggle="tab">Recovery Question</a></li>
        </ul>
    </div>
    ...
    <div class="tab-content">
        <div id="Recovery" class="tab-pane  active">
            <form  method="POST"  role="form" action="recovery_verify_answer.php?user=<?php echo $verify_user ?>">
                <p class="text-muted text-center">
                  <?php 
                  if (!empty($result[$user_type.'_secretquestion'])) {
                  echo  $result[$user_type.'_secretquestion'];
                  }
                  else
                  {
                    echo "<script>alert('Empty Recovery Detail!');
                ...
                <input name="recovery_answer" type="password" placeholder="Secret answer" class="form-control bottom">
    ...
    <div class="text-center">
      ...
      <div class="container">
        ...
        <div class="navbar-header">
          <img src="../assets/img/logo.png" alt=" psu Tracer Study" style="width: 40px; margin-top: 6px; ">
          <a class="navbar-brand" href="#">PSU URDANETA ONLINE YEARBOOK AND ALUMNI PORTAL</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav list-inline">
            <li class="active"><a href="#Recovery" data-toggle="tab">Recovery Question</a></li>
