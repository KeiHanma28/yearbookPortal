                ...
                <div id="content">
                    ...
                    <div class="outer">
                        ...
                        <div class="inner bg-light lter">
                            <center><h1>Get to know the Alumni of Pangasinan State University</h1></center>
                            <hr>
                            <br>
                            <h2>View Alumni Yearbooks</h2>
                            <p>Take a look at the graduates of the Pangasinan State University Academe — from whatever campus, course, and academic year. Get to know and be inspired from their achievements and contribution to the academe.</p>                      
                            <center><h1>Connect with the alumni of Pangasinan State University</h1></center>
                            <h2>Get in touch with the alumni through the Alumni Portal</h2>
                            <p>Interact with the other alumni in the portal by visiting their profile, engaging in forums, post content such as photos, videos, and events. Grow and learn together by sharing knowledge and experiences since you have graduated from the university</p>
                            <?php 
