                    ...
                    <div class="outer">
                        ...
                        <div class="inner bg-light lter">
                         <div class="body" style="margin-top: 10px; margin-left: -45px;">
                            ...
                            $teacher_position = $edit_sql['teacher_position'];
                            ...
                            $teacher_motto = $edit_sql['teacher_motto'];
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="text1" placeholder="Address" class="form-control" name="teacher_address" required="" disabled="" value="<?php echo $teacher_address;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="text1" class="control-label col-lg-4">Personal Motto</label>

                                    <div class="col-lg-8">
                                        <input type="text" id="text1"  disabled="" class="form-control" name="teacher_motto" value="<?php echo $teacher_motto; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                       ...
                                       <?php 
                                       $mstat = mysqli_query($con,"SELECT position_name FROM `position` WHERE position_id = '$teacher_position'");
                                       $mstat = mysqli_fetch_array($mstat);
                                      
                                       ?>
                                        <input type="text" id="text1" placeholder="Position" class="form-control" name="Position" required="" disabled="" value="<?php  echo $mstat['position_name'];?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <?php 
                                    $query_dep = mysqli_query($con,"SELECT * FROM `psu_department` WHERE `department_ID` = $teacher_department");
                                    ?>
