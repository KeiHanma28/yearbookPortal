                            ...
                            <div class="box col-sm-5">
                             ...
                             <div class="body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="text1" placeholder="Address" class="form-control" name="teacher_address">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="text1" placeholder="Personal Motto" class="form-control" name="teacher_motto">
                                    </div>
                                </div>
                                <div class="form-group">
...
<div class="container">
  ...
  <div class="modal-dialog">
    ...
    <div class="row">
                ...
                <form class="form-horizontal" action="action/tcsv.php" method="post" name="upload_excel" enctype="multipart/form-data">
                    <fieldset>
...
<div class="form-group">
    ...
    <a href="csv_teacherformat.csv" download>
