                    ...
                    <div class="outer">
                        <header class="head">
                            ...
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active"> Yearbook</li>
                            </ol>
                            </div>
                            <!-- /.main-bar -->
                        </header>
...
<div class="tab-content">
   <?php 
   $course =mysqli_query($con,"SELECT * FROM `psu_course`");
   $course_data = mysqli_fetch_array($course);
    $dep =mysqli_query($con,"SELECT * FROM `psu_department`");
    $t = mysqli_query($con,"SELECT * FROM `user_teacher_detail`"); 
    while ($data = mysqli_fetch_array($dep)) {
  ...
  <div class="tab-pane active" id="<?php echo $data['department_ID']; ?>" role="tabpanel">
    ...
    $s =mysqli_query($con,"SELECT DISTINCT (year(student_year_grad)) as year_list FROM `user_student_detail` WHERE student_department = $dID");
      ...
      <table  id="c" class="table table-bordered table-advance table-hover  dataTable">
                                      <thead>
                                        <tr>
                                          <th><h3><?php echo  $data['department_name'] ?> Yearbook List</h3></th>
                    ...
                    <br>
                      ...
                      <a href='yearbook_viewfac.php?course=<?php echo $dID;?>&year=<?php echo $year_list;?> ' ><?php echo $year_list;?></a>
                     ...
                     <br>
                      ...
                      <a href='yearbook_viewfac.php?course=<?php echo $dID;?>&year=<?php echo $year_list;?> ' style='background-color: #444444;color: white;'> VIEW</a>
                      </div></td>
                      </tr>
                                          <?php
                                        }
 ...
 $(document).ready(function() {
                ...
                var dataTable = $('#forumData_Pin').DataTable( {
                    ...
                    "columnDefs": [ {
                        ...
                        //          window.location='yearbook_viewfac.php?course=IT&year='+year_data;
