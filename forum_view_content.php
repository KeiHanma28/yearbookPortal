    ...
    $data = mysqli_fetch_array($result);
                        ...
                        <div class="inner bg-light lter">
                          ...
                          <div class="col-lg-12" style="word-wrap: break-word;"><!-- CONTENT START HERE-->
                            <h1><?php echo $body = htmlspecialchars_decode($post_title) ?></h1>
                              <!-- Author -->
                              <p class="lead"><h6>

                                  by <a href='profile.php?id=<?php echo $login_id;?>'><?php  
                                    ...
                                    <li>
                                      ...
                                      $query_verify_id = mysqli_query($con,"SELECT * FROM `forum_comment`");
                                        ...
                                        $cuID = $comment_data['comment_userID'];
                                                ...
                                                else if ($r_udata['user_level'] == '2') {
                                                  # code...teacher
                                                  $u_type = "teacher";
                                                }
                                                else if ($r_udata['user_level'] == '3') {
                                                  # code...admin
                                                  $u_type = "admin";
                                                }
                                                $uID = $r_udata['user_ID'];
