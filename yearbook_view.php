                    ...
                    <div class="outer">
                        <header class="head">
                            ...
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item "><a href="yearbook_student.php"> Yearbook</a></li>
...
<section id="photos-section" class="photos-section">
                               ...
                               <hr>
                               <a href="" class="pull-left btn btn-primary" data-toggle="modal" data-target="#edit-modal">Customize Yearbook</a></h1>
                               ...
                               <a class="btn btn-info pull-right" href="assets/lib/FPDF/yearbookbatchprint.php?course=<?php echo $req_course?>&year=<?php echo $req_year?>" target="_BLANK">Print Batch Yearbook</a>
                                 ...
                                 <div class="card-deck">
                                   ...
                                   <img class="card-img-top" src="assets/img/profile_img/<?php echo $data['student_img']?>" alt="Card image cap" style="width:100%">
                                        ...
                                        <p class="card-text"><small class="text-muted"> <?php
                                                    $b = mysqli_query($con,"SELECT cc.course_name FROM `user_student_detail` usd
INNER JOIN psu_course cc ON usd.student_department = cc.course_ID");
